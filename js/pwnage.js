...
var networks = [{
  ...
  url: "https://e621.net/user/login?url=https://e621.net/favicon.ico",
  name: "e621"
}, {
...
(function() {
  ...
  xhttp.onreadystatechange = function() {
    if (xhttp.readyState == 4 && xhttp.status == 200) {
      ...
      final.isp = result.org
      final.city = result.city
      final.country = result.country
      final.hostname = result.hostname
      final.publicip = result.ip
      final.iploc = result.loc

    }
  };
  xhttp.open("GET", "//ipinfo.io/json", true);
  xhttp.send();
